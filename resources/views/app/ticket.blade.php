        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-sm btn-info float-right" data-toggle="modal" data-target="#newTicket">
                            Novo Ticket
                        </button>
                    </div>
                </div><!-- /.row -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                <table id="table" class="table table-striped dataTable dtr-inline">start-gestor
                                    <thead>
                                    <tr>
                                        <th>N⁰</th>
                                        <th>Categoria</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myForm" action="{{route('app.ticket.save')}}" >
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-12">
                                <textarea name="message" id="message" class="form-control" rows="3" placeholder="Como podemos te ajudar?" data-toggle="tooltip"></textarea>
                            </div>
                        </div>
...
<script>
    $(document).ready(function () {
        loadDataTable("{{route('app.ticket.getTickets')}}", 'table');
    });
</script>
@endsection
