    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Pedidos de {{ empty($reverse) ? 'Entrada' : 'Reversa' }}</h1>
                    </div><!-- /.col -->

                    @if (auth()->user()->can('cadastrar-pedidos'))
                        <div class="col-sm-6">
                    ...
                    @elseif(auth()->user()->can('cadastrar-pedidos-reversa'))
                        <div class="col-sm-6">
                            <button type="button" class="btn btn-success float-right" data-toggle="modal"
                                data-target="#modal-default">
                                <i class="fas fa-plus"></i>
                    ...
                    <div class="col-md-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Lista de Pedidos de {{ empty($reverse) ? 'Entrada' : 'Reversa' }}</h5>
                            </div>
                            <div class="card-body">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="myForm" action="{{ route('adm.orderEntry.new') }}" class="ajax-off">
                        <div class="form-row">
                            ...
                            @can('type-user')
                                <div class="form-group col-12">
                                    <select name="partner_id" id="partner_id" class="custom-select" placeholder="Parceiro"
                                        data-toggle="tooltip">
                                    </select>
                                </div>
                            @endcan
                            <div class="form-group col-12">
                                <input type="date" name="forecast" id="forecast" placeholder="Previsão de Chegada"
                            ...
                            <div class="form-group col-12">
                                ...
                                <input type="hidden" name="reverse" value="{{ $reverse ?? 0 }}">
...
@endsection
<?php $urlDataTable = empty($reverse) ? 'adm.oderEntry.getListOrders' : 'adm.orderReverse.getListOrders'; ?>
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            loadDataTable("{{ route($urlDataTable) }}", 'table');
        });
    </script>
@endsection
