    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Relatórios de Pedidos de Entrada</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div class="row">
                    <!--FORM-->
                    <div class="col-12">
                        <form action="{{route('adm.reports.orderEntry.setFilter')}}">
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-2">
                                    <a href="{{route('adm.reports.orderEntry.clearFilter')}}" class="btn btn-block btn-danger ajax-link"> Limpar Filtros </a>
                                </div>
                                <div class="form-group col-md-2">
                                    @csrf
...
<script>
    $(document).ready(function () {
        loadDataTableWithButtons("{{route('adm.reports.orderEntry.getOrderEntries')}}", 'table');
    });
</script>
@endsection
